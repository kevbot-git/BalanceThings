...
namespace BalanceThings.Items
{
    class Hand : GameObject
    {
        internal Hand(World world, ContentManager contentManager, Vector2 position)
            : base(BodyFactory.CreateCapsule(world, ConvertUnits.ToSimUnits(6f), ConvertUnits.ToSimUnits(1f), 2,
                ConvertUnits.ToSimUnits(1f), 2, 1f, ConvertUnits.ToSimUnits(position + new Vector2(6, 1))),
